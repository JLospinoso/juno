...
public class CcpInsertionEgoLikelihoodRatioCalculator implements EgoLikelihoodRatioCalculator {
    private final CachedNaturalLogarithm naturalLogarithm;

    public CcpInsertionEgoLikelihoodRatioCalculator(CachedNaturalLogarithm naturalLogarithm) {
