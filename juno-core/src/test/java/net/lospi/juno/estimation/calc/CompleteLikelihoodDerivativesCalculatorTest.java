...
@Test(groups="unit")
public class CompleteLikelihoodDerivativesCalculatorTest {
    ...
    public void noSampleThrow() {
        CompleteLikelihoodDerivativesCalculator underStudy = new CompleteLikelihoodDerivativesCalculator();
    ...
    public void calculate() {
        ...
        assertThat(result.getInformation().getEntry(0,0)).isEqualTo( 2.5 , tolerance);
        ...
        assertThat(result.getInformation().getEntry(1,1)).isEqualTo( 5.0, tolerance);
    }
}
