...
@Test(groups="unit")
public class CcpDeletionEgoLikelihoodRatioCalculatorTest {
    ...
    public void testCalculate() throws Exception {
        CcpDeletionEgoLikelihoodRatioCalculator calculator = new CcpDeletionEgoLikelihoodRatioCalculator(naturalLogarithm);
